 ...
 * Plugin URI: https://github.com/Plisio/woocommerce-plugin/releases/download/v1.0.8/plisio-gateway-for-woocommerce-1.0.8.zip
...
function plisio_init()
{
    ...
    define('PLISIO_WOOCOMMERCE_VERSION', '1.0.8');
